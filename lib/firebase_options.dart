...
class DefaultFirebaseOptions {
  ...
  // Note: These options have been updated to load configuration from environment variables
  // at build time using --dart-define-from-file. Re-running FlutterFire CLI will overwrite this.
